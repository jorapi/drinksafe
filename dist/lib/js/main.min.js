...
"use strict";angular.module("lr.upload",["lr.upload.formdata","lr.upload.iframe","lr.upload.directives"]),angular.module("lr.upload.directives",[]),angular.module("lr.upload.directives").directive("uploadButton",["upload",function(e){return{restrict:"EA",scope:{data:"=?data",url:"@",param:"@",method:"@",onUpload:"&",onSuccess:"&",onError:"&",onComplete:"&"},link:function(a,r,t){var n=angular.element(r),o=angular.element('<input type="file" />');if(n.append(o),o.on("change",function(){var r=angular.element(this);if(!r[0].files||0!==r[0].files.length){var n={url:a.url,method:a.method||"POST",forceIFrameUpload:a.$eval(t.forceIframeUpload)||!1,data:a.data||{}};n.data[a.param||"file"]=r,a.$apply(function(){a.onUpload({files:r[0].files})}),e(n).then(function(e){a.onSuccess({response:e}),a.onComplete({response:e})},function(e){a.onError({response:e}),a.onComplete({response:e})})}}),"required"in t&&t.$observe("required",function(e){var t=""===e?!0:a.$eval(e);o.attr("required",t),r.toggleClass("ng-valid",!t),r.toggleClass("ng-invalid ng-invalid-required",t)}),"accept"in t&&t.$observe("accept",function(e){o.attr("accept",e)}),e.support.formData){var l=function(){o.attr("multiple",!(!a.$eval(t.multiple)||a.$eval(t.forceIframeUpload)))};t.$observe("multiple",l),t.$observe("forceIframeUpload",l)}}}}]),angular.module("lr.upload.formdata",[]).factory("formDataTransform",function(){return function(e){var a=new FormData;return angular.forEach(e,function(e,r){if(angular.isElement(e)){var t=[];angular.forEach(e,function(e){angular.forEach(e.files,function(e){t.push(e)}),e.value=""}),0!==t.length&&(t.length>1?angular.forEach(t,function(e,t){a.append(r+"["+t+"]",e)}):a.append(r,t[0]))}else a.append(r,e)}),a}}).factory("formDataUpload",["$http","formDataTransform",function(e,a){return function(r){return r.transformRequest=a,r.method=r.method||"POST",r.headers=angular.extend(r.headers||{},{"Content-Type":void 0}),e(r)}}]),angular.module("lr.upload.iframe",[]).factory("iFrameUpload",["$q","$http","$document","$rootScope",function(e,a,r,t){function n(e,a){if(e.indexOf)return e.indexOf(a);for(var r=0;r<e.length;r++)if(a===e[r])return r;return-1}function o(o){var l=[],u=e.defer(),i=u.promise;angular.forEach(o.data||{},function(e,a){angular.isElement(e)&&(delete o.data[a],e.attr("name",a),l.push(e))});var d=/\?/.test(o.url)?"&":"?";"DELETE"===o.method?(o.url=o.url+d+"_method=DELETE",o.method="POST"):"PUT"===o.method?(o.url=o.url+d+"_method=PUT",o.method="POST"):"PATCH"===o.method&&(o.url=o.url+d+"_method=PATCH",o.method="POST");var f=angular.element(r[0].body),p=t.$new(),m="iframe-transport-"+p.$id;p.$destroy();var s=angular.element("<form></form>");s.attr("target",m),s.attr("action",o.url),s.attr("method",o.method||"POST"),s.css("display","none"),l.length&&(s.attr("enctype","multipart/form-data"),s.attr("encoding","multipart/form-data"));var c=angular.element('<iframe name="'+m+'" src="javascript:false;"></iframe>');return c.on("load",function(){function e(e,a){var r=[];return angular.isFunction(a)?a(e,r):(angular.forEach(a,function(a){e=a(e,r)}),e)}function r(){var e=n(a.pendingRequests,o);-1!==e&&(a.pendingRequests.splice(e,1),o.$iframeTransportForm.remove(),delete o.$iframeTransportForm)}c.off("load").on("load",function(){var r;try{var t=this.contentWindow?this.contentWindow.document:this.contentDocument;if(r=angular.element(t.body).text(),!r.length)throw new Error}catch(n){}s.append(angular.element('<iframe src="javascript:false;"></iframe>'));try{r=e(r,a.defaults.transformResponse)}catch(n){}u.resolve({data:r,status:200,headers:[],config:o})}),angular.forEach(o.data,function(e,a){var r=angular.element('<input type="hidden" />');r.attr("name",a),r.val(e),s.append(r)}),angular.forEach(l,function(e){var a=e.clone(!0);e.after(a),s.append(e)}),o.$iframeTransportForm=s,a.pendingRequests.push(o),s[0].submit(),i.then(r,r)}),s.append(c),f.append(s),i}return o}]),angular.module("lr.upload").factory("upload",["$window","formDataUpload","iFrameUpload",function(e,a,r){function t(e){return n.formData&&!e.forceIFrameUpload?a(e):r(e)}var n={fileInput:!(new RegExp("(Android (1\\.[0156]|2\\.[01]))|(Windows Phone (OS 7|8\\.0))|(XBLWP)|(ZuneWP)|(WPDesktop)|(w(eb)?OSBrowser)|(webOS)|(Kindle/(1\\.0|2\\.[05]|3\\.0))").test(e.navigator.userAgent)||angular.element('<input type="file">').prop("disabled")),fileUpload:!(!e.XMLHttpRequestUpload||!e.FileReader),formData:!!e.FormData};return t.support=n,t}]);
!function(n,t,e){"use strict";t.module("ngAnimate",["ng"]).directive("ngAnimateChildren",function(){return function(n,e,a){a=a.ngAnimateChildren,t.isString(a)&&0===a.length?e.data("$$ngAnimateChildren",!0):n.$watch(a,function(n){e.data("$$ngAnimateChildren",!!n)})}}).factory("$$animateReflow",["$$rAF","$document",function(n,t){var e=t[0].body;return function(t){return n(function(){t(e.offsetWidth)})}}]).config(["$provide","$animateProvider",function(a,i){function r(n){for(var t=0;t<n.length;t++){var e=n[t];if(e.nodeType==c)return e}}function s(n){return t.element(r(n))}var o=t.noop,l=t.forEach,u=i.$$selectors,c=1,f="$$ngAnimateState",d="$$ngAnimateChildren",v="ng-animate",m={running:!0};a.decorator("$animate",["$delegate","$injector","$sniffer","$rootElement","$$asyncCallback","$rootScope","$document",function(n,e,a,c,g,C,p){function h(n){var t=n.data(f)||{};t.running=!0,n.data(f,t)}function y(n){if(n){var t=[],i={};n=n.substr(1).split("."),(a.transitions||a.animations)&&t.push(e.get(u[""]));for(var r=0;r<n.length;r++){var s=n[r],o=u[s];o&&!i[s]&&(t.push(e.get(o)),i[s]=!0)}return t}}function $(n,e,a){function i(n,t){var e=n[t],a=n["before"+t.charAt(0).toUpperCase()+t.substr(1)];return e||a?("leave"==t&&(a=e,e=null),$.push({event:t,fn:e}),C.push({event:t,fn:a}),!0):void 0}function r(t,e,i){var r=[];l(t,function(n){n.fn&&r.push(n)});var s=0;l(r,function(t,l){var f=function(){n:{if(e){if((e[l]||o)(),++s<r.length)break n;e=null}i()}};switch(t.event){case"setClass":e.push(t.fn(n,u,c,f));break;case"addClass":e.push(t.fn(n,u||a,f));break;case"removeClass":e.push(t.fn(n,c||a,f));break;default:e.push(t.fn(n,f))}}),e&&0===e.length&&i()}var s=n[0];if(s){var u,c,f="setClass"==e,d=f||"addClass"==e||"removeClass"==e;t.isArray(a)&&(u=a[0],c=a[1],a=u+" "+c);var v=n.attr("class")+" "+a;if(x(v)){var m=o,g=[],C=[],p=o,h=[],$=[],v=(" "+v).replace(/\s+/g,".");return l(y(v),function(n){!i(n,e)&&f&&(i(n,"addClass"),i(n,"removeClass"))}),{node:s,event:e,className:a,isClassBased:d,isSetClassOperation:f,before:function(n){m=n,r(C,g,function(){m=o,n()})},after:function(n){p=n,r($,h,function(){p=o,n()})},cancel:function(){g&&(l(g,function(n){(n||o)(!0)}),m(!0)),h&&(l(h,function(n){(n||o)(!0)}),p(!0))}}}}}function D(n,e,a,i,r,s,o){function u(t){var i="$animate:"+t;y&&y[i]&&0<y[i].length&&g(function(){a.triggerHandler(i,{event:n,className:e})})}function c(){u("before")}function d(){u("after")}function m(){u("close"),o&&g(function(){o()})}function C(){C.hasBeenRun||(C.hasBeenRun=!0,s())}function p(){if(!p.hasBeenRun){p.hasBeenRun=!0;var t=a.data(f);t&&(h&&h.isClassBased?A(a,e):(g(function(){var t=a.data(f)||{};F==t.index&&A(a,e,n)}),a.data(f,t))),m()}}var h=$(a,n,e);if(h){e=h.className;var y=t.element._data(h.node),y=y&&y.events;i||(i=r?r.parent():a.parent());var D=a.data(f)||{};r=D.active||{};var b,k=D.totalActive||0,x=D.last;if(h.isClassBased&&(b=D.running||D.disabled||x&&!x.isClassBased),b||w(a,i))C(),c(),d(),p();else{if(i=!1,k>0){if(b=[],h.isClassBased)"setClass"==x.event?(b.push(x),A(a,e)):r[e]&&(B=r[e],B.event==n?i=!0:(b.push(B),A(a,e)));else if("leave"==n&&r["ng-leave"])i=!0;else{for(var B in r)b.push(r[B]),A(a,B);r={},k=0}0<b.length&&l(b,function(n){n.cancel()})}if(!h.isClassBased||h.isSetClassOperation||i||(i="addClass"==n==a.hasClass(e)),i)C(),c(),d(),m();else{"leave"==n&&a.one("$destroy",function(n){n=t.element(this);var e=n.data(f);e&&(e=e.active["ng-leave"])&&(e.cancel(),A(n,"ng-leave"))}),a.addClass(v);var F=S++;k++,r[e]=h,a.data(f,{last:h,active:r,index:F,totalActive:k}),c(),h.before(function(t){var i=a.data(f);t=t||!i||!i.active[e]||h.isClassBased&&i.active[e].event!=n,C(),!0===t?p():(d(),h.after(p))})}}}else C(),c(),d(),p()}function b(n){(n=r(n))&&(n=t.isFunction(n.getElementsByClassName)?n.getElementsByClassName(v):n.querySelectorAll("."+v),l(n,function(n){n=t.element(n),(n=n.data(f))&&n.active&&l(n.active,function(n){n.cancel()})}))}function A(n,t){if(r(n)==r(c))m.disabled||(m.running=!1,m.structural=!1);else if(t){var e=n.data(f)||{},a=!0===t;!a&&e.active&&e.active[t]&&(e.totalActive--,delete e.active[t]),(a||!e.totalActive)&&(n.removeClass(v),n.removeData(f))}}function w(n,e){if(m.disabled)return!0;if(r(n)==r(c))return m.running;var a,i,s;do{if(0===e.length)break;var o=r(e)==r(c),l=o?m:e.data(f)||{};if(l.disabled)return!0;o&&(s=!0),!1!==a&&(o=e.data(d),t.isDefined(o)&&(a=o)),i=i||l.running||l.last&&!l.last.isClassBased}while(e=e.parent());return!s||!a&&i}var S=0;c.data(f,m),C.$$postDigest(function(){C.$$postDigest(function(){m.running=!1})});var k=i.classNameFilter(),x=k?function(n){return k.test(n)}:function(){return!0};return{enter:function(e,a,i,r){e=t.element(e),a=a&&t.element(a),i=i&&t.element(i),h(e),n.enter(e,a,i),C.$$postDigest(function(){e=s(e),D("enter","ng-enter",e,a,i,o,r)})},leave:function(e,a){e=t.element(e),b(e),h(e),C.$$postDigest(function(){D("leave","ng-leave",s(e),null,null,function(){n.leave(e)},a)})},move:function(e,a,i,r){e=t.element(e),a=a&&t.element(a),i=i&&t.element(i),b(e),h(e),n.move(e,a,i),C.$$postDigest(function(){e=s(e),D("move","ng-move",e,a,i,o,r)})},addClass:function(e,a,i){e=t.element(e),e=s(e),D("addClass",a,e,null,null,function(){n.addClass(e,a)},i)},removeClass:function(e,a,i){e=t.element(e),e=s(e),D("removeClass",a,e,null,null,function(){n.removeClass(e,a)},i)},setClass:function(e,a,i,r){e=t.element(e),e=s(e),D("setClass",[a,i],e,null,null,function(){n.setClass(e,a,i)},r)},enabled:function(n,t){switch(arguments.length){case 2:if(n)A(t);else{var e=t.data(f)||{};e.disabled=!0,t.data(f,e)}break;case 1:m.disabled=!n;break;default:n=!m.disabled}return!!n}}}]),i.register("",["$window","$sniffer","$timeout","$$animateReflow",function(a,i,s,u){function f(){P||(P=u(function(){J=[],P=null,z={}}))}function d(n,t){P&&P(),J.push(t),P=u(function(){l(J,function(n){n()}),J=[],P=null,z={}})}function v(n,e){var a=r(n);n=t.element(a),V.push(n),a=Date.now()+e,Q>=a||(s.cancel(L),Q=a,L=s(function(){m(V),V=[]},e,!1))}function m(n){l(n,function(n){(n=n.data(q))&&(n.closeAnimationFn||o)()})}function g(n,t){var e=t?z[t]:null;if(!e){var i,r,s,o,u=0,f=0,d=0,v=0;l(n,function(n){if(n.nodeType==c){n=a.getComputedStyle(n)||{},s=n[F+T],u=Math.max(C(s),u),o=n[F+I],i=n[F+O],f=Math.max(C(i),f),r=n[E+O],v=Math.max(C(r),v);var t=C(n[E+T]);t>0&&(t*=parseInt(n[E+W],10)||1),d=Math.max(t,d)}}),e={total:0,transitionPropertyStyle:o,transitionDurationStyle:s,transitionDelayStyle:i,transitionDelay:f,transitionDuration:u,animationDelayStyle:r,animationDelay:v,animationDuration:d},t&&(z[t]=e)}return e}function C(n){var e=0;return n=t.isString(n)?n.split(/\s*,\s*/):[],l(n,function(n){e=Math.max(parseFloat(n)||0,e)}),e}function p(n){var t=n.parent(),e=t.data(j);return e||(t.data(j,++G),e=G),e+"-"+r(n).getAttribute("class")}function h(n,t,e,a){var i=p(t),s=i+" "+e,l=z[s]?++z[s].total:0,u={};if(l>0){var c=e+"-stagger",u=i+" "+c;(i=!z[u])&&t.addClass(c),u=g(t,u),i&&t.removeClass(c)}a=a||function(n){return n()},t.addClass(e);var c=t.data(q)||{},f=a(function(){return g(t,s)});return a=f.transitionDuration,i=f.animationDuration,0===a&&0===i?(t.removeClass(e),!1):(t.data(q,{running:c.running||0,itemIndex:l,stagger:u,timings:f,closeAnimationFn:o}),n=0<c.running||"setClass"==n,a>0&&y(t,e,n),i>0&&0<u.animationDelay&&0===u.animationDuration&&(r(t).style[E]="none 0s"),!0)}function y(n,t,e){"ng-enter"!=t&&"ng-move"!=t&&"ng-leave"!=t&&e?n.addClass(H):r(n).style[F+I]="none"}function $(n,t){var e=F+I,a=r(n);a.style[e]&&0<a.style[e].length&&(a.style[e]=""),n.removeClass(H)}function D(n){var t=E;n=r(n),n.style[t]&&0<n.style[t].length&&(n.style[t]="")}function b(n,t,e,a){function i(n){t.off(h,s),t.removeClass(u),x(t,e),n=r(t);for(var a in $)n.style.removeProperty($[a])}function s(n){n.stopPropagation();var t=n.originalEvent||n;n=t.$manualTimeStamp||t.timeStamp||Date.now(),t=parseFloat(t.elapsedTime.toFixed(K)),Math.max(n-p,0)>=C&&t>=m&&a()}var o=r(t);if(n=t.data(q),-1!=o.getAttribute("class").indexOf(e)&&n){var u="";l(e.split(" "),function(n,t){u+=(t>0?" ":"")+n+"-active"});var c=n.stagger,f=n.timings,d=n.itemIndex,m=Math.max(f.transitionDuration,f.animationDuration),g=Math.max(f.transitionDelay,f.animationDelay),C=g*_,p=Date.now(),h=R+" "+M,y="",$=[];if(0<f.transitionDuration){var D=f.transitionPropertyStyle;-1==D.indexOf("all")&&(y+=N+"transition-property: "+D+";",y+=N+"transition-duration: "+f.transitionDurationStyle+";",$.push(N+"transition-property"),$.push(N+"transition-duration"))}return d>0&&(0<c.transitionDelay&&0===c.transitionDuration&&(y+=N+"transition-delay: "+A(f.transitionDelayStyle,c.transitionDelay,d)+"; ",$.push(N+"transition-delay")),0<c.animationDelay&&0===c.animationDuration&&(y+=N+"animation-delay: "+A(f.animationDelayStyle,c.animationDelay,d)+"; ",$.push(N+"animation-delay"))),0<$.length&&(f=o.getAttribute("style")||"",o.setAttribute("style",f+"; "+y)),t.on(h,s),t.addClass(u),n.closeAnimationFn=function(){i(),a()},o=(d*(Math.max(c.animationDelay,c.transitionDelay)||0)+(g+m)*U)*_,n.running++,v(t,o),i}a()}function A(n,t,e){var a="";return l(n.split(","),function(n,i){a+=(i>0?",":"")+(e*t+parseInt(n,10))+"s"}),a}function w(n,t,e,a){return h(n,t,e,a)?function(n){n&&x(t,e)}:void 0}function S(n,t,e,a){return t.data(q)?b(n,t,e,a):(x(t,e),void a())}function k(n,t,e,a){var i=w(n,t,e);if(i){var r=i;return d(t,function(){$(t,e),D(t),r=S(n,t,e,a)}),function(n){(r||o)(n)}}f(),a()}function x(n,t){n.removeClass(t);var e=n.data(q);e&&(e.running&&e.running--,e.running&&0!==e.running||n.removeData(q))}function B(n,e){var a="";return n=t.isArray(n)?n:n.split(/\s+/),l(n,function(n,t){n&&0<n.length&&(a+=(t>0?" ":"")+n+e)}),a}var F,M,E,R,N="";n.ontransitionend===e&&n.onwebkittransitionend!==e?(N="-webkit-",F="WebkitTransition",M="webkitTransitionEnd transitionend"):(F="transition",M="transitionend"),n.onanimationend===e&&n.onwebkitanimationend!==e?(N="-webkit-",E="WebkitAnimation",R="webkitAnimationEnd animationend"):(E="animation",R="animationend");var P,T="Duration",I="Property",O="Delay",W="IterationCount",j="$$ngAnimateKey",q="$$ngAnimateCSS3Data",H="ng-animate-block-transitions",K=3,U=1.5,_=1e3,z={},G=0,J=[],L=null,Q=0,V=[];return{enter:function(n,t){return k("enter",n,"ng-enter",t)},leave:function(n,t){return k("leave",n,"ng-leave",t)},move:function(n,t){return k("move",n,"ng-move",t)},beforeSetClass:function(n,t,e,a){var i=B(e,"-remove")+" "+B(t,"-add"),r=w("setClass",n,i,function(a){var i=n.attr("class");return n.removeClass(e),n.addClass(t),a=a(),n.attr("class",i),a});return r?(d(n,function(){$(n,i),D(n),a()}),r):(f(),void a())},beforeAddClass:function(n,t,e){var a=w("addClass",n,B(t,"-add"),function(e){return n.addClass(t),e=e(),n.removeClass(t),e});return a?(d(n,function(){$(n,t),D(n),e()}),a):(f(),void e())},setClass:function(n,t,e,a){return e=B(e,"-remove"),t=B(t,"-add"),S("setClass",n,e+" "+t,a)},addClass:function(n,t,e){return S("addClass",n,B(t,"-add"),e)},beforeRemoveClass:function(n,t,e){var a=w("removeClass",n,B(t,"-remove"),function(e){var a=n.attr("class");return n.removeClass(t),e=e(),n.attr("class",a),e});return a?(d(n,function(){$(n,t),D(n),e()}),a):void e()},removeClass:function(n,t,e){return S("removeClass",n,B(t,"-remove"),e)}}}])}])}(window,window.angular);
!function(e,r,t){"use strict";function n(e,t,n){return{restrict:"ECA",terminal:!0,priority:400,transclude:"element",link:function(a,o,i,c,l){function u(){h&&(h.remove(),h=null),p&&(p.$destroy(),p=null),$&&(n.leave($,function(){h=null}),h=$,$=null)}function s(){var i=e.current&&e.current.locals;if(r.isDefined(i&&i.$template)){var i=a.$new(),c=e.current;$=l(i,function(e){n.enter(e,null,$||o,function(){!r.isDefined(f)||f&&!a.$eval(f)||t()}),u()}),p=c.scope=i,p.$emit("$viewContentLoaded"),p.$eval(d)}else u()}var p,$,h,f=i.autoscroll,d=i.onload||"";a.$on("$routeChangeSuccess",s),s()}}}function a(e,r,t){return{restrict:"ECA",priority:-400,link:function(n,a){var o=t.current,i=o.locals;a.html(i.$template);var c=e(a.contents());o.controller&&(i.$scope=n,i=r(o.controller,i),o.controllerAs&&(n[o.controllerAs]=i),a.data("$ngControllerController",i),a.children().data("$ngControllerController",i)),c(n)}}}e=r.module("ngRoute",["ng"]).provider("$route",function(){function e(e,t){return r.extend(new(r.extend(function(){},{prototype:e})),t)}function t(e,r){var t=r.caseInsensitiveMatch,n={originalPath:e,regexp:e},a=n.keys=[];return e=e.replace(/([().])/g,"\\$1").replace(/(\/)?:(\w+)([\?\*])?/g,function(e,r,t,n){return e="?"===n?n:null,n="*"===n?n:null,a.push({name:t,optional:!!e}),r=r||"",""+(e?"":r)+"(?:"+(e?r:"")+(n&&"(.+?)"||"([^/]+)")+(e||"")+")"+(e||"")}).replace(/([\/$\*])/g,"\\$1"),n.regexp=RegExp("^"+e+"$",t?"i":""),n}var n={};this.when=function(e,a){if(n[e]=r.extend({reloadOnSearch:!0},a,e&&t(e,a)),e){var o="/"==e[e.length-1]?e.substr(0,e.length-1):e+"/";n[o]=r.extend({redirectTo:e},t(o,a))}return this},this.otherwise=function(e){return this.when(null,e),this},this.$get=["$rootScope","$location","$routeParams","$q","$injector","$http","$templateCache","$sce",function(t,a,o,i,c,l,u,s){function p(){var e=$(),n=d.current;e&&n&&e.$$route===n.$$route&&r.equals(e.pathParams,n.pathParams)&&!e.reloadOnSearch&&!f?(n.params=e.params,r.copy(n.params,o),t.$broadcast("$routeUpdate",n)):(e||n)&&(f=!1,t.$broadcast("$routeChangeStart",e,n),(d.current=e)&&e.redirectTo&&(r.isString(e.redirectTo)?a.path(h(e.redirectTo,e.params)).search(e.params).replace():a.url(e.redirectTo(e.pathParams,a.path(),a.search())).replace()),i.when(e).then(function(){if(e){var t,n,a=r.extend({},e.resolve);return r.forEach(a,function(e,t){a[t]=r.isString(e)?c.get(e):c.invoke(e)}),r.isDefined(t=e.template)?r.isFunction(t)&&(t=t(e.params)):r.isDefined(n=e.templateUrl)&&(r.isFunction(n)&&(n=n(e.params)),n=s.getTrustedResourceUrl(n),r.isDefined(n)&&(e.loadedTemplateUrl=n,t=l.get(n,{cache:u}).then(function(e){return e.data}))),r.isDefined(t)&&(a.$template=t),i.all(a)}}).then(function(a){e==d.current&&(e&&(e.locals=a,r.copy(e.params,o)),t.$broadcast("$routeChangeSuccess",e,n))},function(r){e==d.current&&t.$broadcast("$routeChangeError",e,n,r)}))}function $(){var t,o;return r.forEach(n,function(n,i){var c;if(c=!o){var l=a.path();c=n.keys;var u={};if(n.regexp)if(l=n.regexp.exec(l)){for(var s=1,p=l.length;p>s;++s){var $=c[s-1],h=l[s];$&&h&&(u[$.name]=h)}c=u}else c=null;else c=null;c=t=c}c&&(o=e(n,{params:r.extend({},a.search(),t),pathParams:t}),o.$$route=n)}),o||n[null]&&e(n[null],{params:{},pathParams:{}})}function h(e,t){var n=[];return r.forEach((e||"").split(":"),function(e,r){if(0===r)n.push(e);else{var a=e.match(/(\w+)(?:[?*])?(.*)/),o=a[1];n.push(t[o]),n.push(a[2]||""),delete t[o]}}),n.join("")}var f=!1,d={routes:n,reload:function(){f=!0,t.$evalAsync(p)}};return t.$on("$locationChangeSuccess",p),d}]}),e.provider("$routeParams",function(){this.$get=function(){return{}}}),e.directive("ngView",n),e.directive("ngView",a),n.$inject=["$route","$anchorScroll","$animate"],a.$inject=["$compile","$controller","$route"]}(window,window.angular);
"use strict";!function(e,t){"undefined"!=typeof module&&module.exports?module.exports=t(require("angular")):"function"==typeof define&&define.amd?define(["angular"],t):t(e.angular)}(window,function(e){e.module("angucomplete-alt",[]).directive("angucompleteAlt",["$q","$parse","$http","$sce","$timeout","$templateCache","$interpolate",function(e,t,n,r,l,i,o){function s(t,i,o,s){function I(e,n){e&&("object"==typeof e?(t.searchStr=$(e),b({originalObject:e})):"string"==typeof e&&e.length>0?t.searchStr=e:console&&console.error&&console.error("Tried to set "+(n?"initial":"")+" value of angucomplete to",e,"which is an invalid value"),U(!0))}function y(e){pe=null,t.hideResults(e),document.body.removeEventListener("click",y)}function R(e){return e.which?e.which:e.keyCode}function b(e){"function"==typeof t.selectedObject?t.selectedObject(e):t.selectedObject=e,U(e?!0:!1)}function D(e){return function(n){return t[e]?t[e](n):n}}function F(e){b({originalObject:e}),t.clearSelected&&(t.searchStr=null),Y()}function $(e){return t.titleField.split(",").map(function(t){return q(e,t)}).join(" ")}function q(e,t){var n,r;if(t){n=t.split("."),r=e;for(var l=0;l<n.length;l++)r=r[n[l]]}else r=e;return r}function O(e,n){var l,i,o;return o=new RegExp(n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),"i"),e?(e.match&&e.replace||(e=e.toString()),i=e.match(o),l=i?e.replace(o,'<span class="'+t.matchClass+'">'+i[0]+"</span>"):e,r.trustAsHtml(l)):void 0}function U(e){t.notEmpty=e,ae=t.searchStr,t.fieldRequired&&s&&t.inputName&&s[t.inputName].$setValidity(se,e)}function j(e){var n=R(e);if(n!==d&&n!==c)if(n===u||n===g)e.preventDefault();else if(n===a)e.preventDefault(),!t.showDropdown&&t.searchStr&&t.searchStr.length>=ie&&(G(),t.searching=!0,P(t.searchStr));else if(n===p)Y(),t.$apply(function(){le.val(t.searchStr)});else{if(0===ie&&!t.searchStr)return;t.searchStr&&""!==t.searchStr?t.searchStr.length>=ie&&(G(),oe&&l.cancel(oe),t.searching=!0,oe=l(function(){P(t.searchStr)},t.pause)):t.showDropdown=!1,ae&&ae!==t.searchStr&&!t.clearSelected&&t.$apply(function(){b()})}}function H(e){!t.overrideSuggestions||t.selectedObject&&t.selectedObject.originalObject===t.searchStr||(e&&e.preventDefault(),l.cancel(oe),M(),F(t.searchStr))}function N(e){var t=getComputedStyle(e);return e.offsetHeight+parseInt(t.marginTop,10)+parseInt(t.marginBottom,10)}function k(){return ue.getBoundingClientRect().top+parseInt(getComputedStyle(ue).maxHeight,10)}function E(){return i[0].querySelectorAll(".angucomplete-row")[t.currentIndex]}function A(){return E().getBoundingClientRect().top-(ue.getBoundingClientRect().top+parseInt(getComputedStyle(ue).paddingTop,10))}function T(e){ue.scrollTop=ue.scrollTop+e}function L(){var e=t.results[t.currentIndex];t.matchClass?le.val($(e.originalObject)):le.val(e.title)}function B(e){var n=R(e),r=null,l=null;n===g&&t.results?(t.currentIndex>=0&&t.currentIndex<t.results.length?(e.preventDefault(),t.selectResult(t.results[t.currentIndex])):(H(e),Y()),t.$apply()):n===a&&t.results?(e.preventDefault(),t.currentIndex+1<t.results.length&&t.showDropdown&&(t.$apply(function(){t.currentIndex++,L()}),de&&(r=E(),k()<r.getBoundingClientRect().bottom&&T(N(r))))):n===u&&t.results?(e.preventDefault(),t.currentIndex>=1?(t.$apply(function(){t.currentIndex--,L()}),de&&(l=A(),0>l&&T(l-1))):0===t.currentIndex&&t.$apply(function(){t.currentIndex=-1,le.val(t.searchStr)})):n===h?t.results&&t.results.length>0&&t.showDropdown?-1===t.currentIndex&&t.overrideSuggestions?H():(-1===t.currentIndex&&(t.currentIndex=0),t.selectResult(t.results[t.currentIndex]),t.$digest()):t.searchStr&&t.searchStr.length>0&&H():n===p&&e.preventDefault()}function V(e){return function(n,r,l,i){r||l||i||!n.data||(n=n.data),t.searching=!1,Q(q(ee(n),t.remoteUrlDataField),e)}}function _(e,n,r,l){0!==n&&-1!==n&&(n||r||l||(n=e.status),t.remoteUrlErrorCallback?t.remoteUrlErrorCallback(e,n,r,l):console&&console.error&&console.error("http error"))}function M(){ce&&ce.resolve()}function W(r){var l={},i=t.remoteUrl+encodeURIComponent(r);t.remoteUrlRequestFormatter&&(l={params:t.remoteUrlRequestFormatter(r)},i=t.remoteUrl),t.remoteUrlRequestWithCredentials&&(l.withCredentials=!0),M(),ce=e.defer(),l.timeout=ce.promise,n.get(i,l).success(V(r)).error(_)}function z(n){M(),ce=e.defer(),t.remoteApiHandler(n,ce.promise).then(V(n))["catch"](_)}function Y(){t.showDropdown=!1,t.results=[],ue&&(ue.scrollTop=0)}function G(){t.showDropdown=ne,t.currentIndex=t.focusFirst?0:-1,t.results=[]}function J(e){var n,r,l,i,o=t.searchFields.split(","),s=[];for("undefined"!=typeof t.parseInput()&&(e=t.parseInput()(e)),n=0;n<t.localData.length;n++){for(r=!1,l=0;l<o.length;l++)i=q(t.localData[n],o[l])||"",r=r||i.toString().toLowerCase().indexOf(e.toString().toLowerCase())>=0;r&&(s[s.length]=t.localData[n])}t.searching=!1,Q(s,e)}function K(e,n,r){if(!r)return!1;for(var l in n)if(n[l].toLowerCase()===r.toLowerCase())return t.selectResult(e),!0;return!1}function P(e){!e||e.length<ie||(t.localData?t.$apply(function(){J(e)}):t.remoteApiHandler?z(e):W(e))}function Q(e,n){var r,l,i,o,s,a;if(e&&e.length>0)for(t.results=[],r=0;r<e.length;r++)t.titleField&&""!==t.titleField&&(o=s=$(e[r])),l="",t.descriptionField&&(l=a=q(e[r],t.descriptionField)),i="",t.imageField&&(i=q(e[r],t.imageField)),t.matchClass&&(s=O(o,n),a=O(l,n)),t.results[t.results.length]={title:s,description:a,image:i,originalObject:e[r]};else t.results=[];t.autoMatch&&1===t.results.length&&K(t.results[0],{title:o,desc:l||""},t.searchStr)?t.showDropdown=!1:0!==t.results.length||re?t.showDropdown=!0:t.showDropdown=!1}function X(){t.localData?Q(t.localData,""):t.remoteApiHandler?z(""):W("")}var Z,ee,te,ne,re,le=i.find("input"),ie=f,oe=null,se=w,ae=null,ce=null,ue=i[0].querySelector(".angucomplete-dropdown"),de=!1,pe=null;i.on("mousedown",function(e){e.target.id?(pe=e.target.id,pe===t.id+"_dropdown"&&document.body.addEventListener("click",y)):pe=e.target.className}),t.currentIndex=t.focusFirst?0:null,t.searching=!1,te=t.$watch("initialValue",function(e){e&&(te(),I(e,!0))}),t.$watch("fieldRequired",function(e,n){e!==n&&(e?U(ae&&-1!==t.currentIndex?!0:!1):s[t.inputName].$setValidity(se,!0))}),t.$on("angucomplete-alt:clearInput",function(e,n){n&&n!==t.id||(t.searchStr=null,b(),U(!1),Y())}),t.$on("angucomplete-alt:changeInput",function(e,n,r){n&&n===t.id&&I(r)}),t.onFocusHandler=function(){t.focusIn&&t.focusIn(),0!==ie||t.searchStr&&0!==t.searchStr.length||(t.currentIndex=t.focusFirst?0:t.currentIndex,t.showDropdown=!0,X())},t.hideResults=function(){pe&&(pe===t.id+"_dropdown"||pe.indexOf("angucomplete")>=0)?pe=null:(Z=l(function(){Y(),t.$apply(function(){t.searchStr&&t.searchStr.length>0&&le.val(t.searchStr)})},S),M(),t.focusOut&&t.focusOut(),t.overrideSuggestions&&t.searchStr&&t.searchStr.length>0&&-1===t.currentIndex&&H())},t.resetHideResults=function(){Z&&l.cancel(Z)},t.hoverRow=function(e){t.currentIndex=e},t.selectResult=function(e){t.matchClass&&(e.title=$(e.originalObject),e.description=q(e.originalObject,t.descriptionField)),t.clearSelected?t.searchStr=null:t.searchStr=e.title,b(e),Y()},t.inputChangeHandler=function(e){return e.length<ie?(M(),Y()):0===e.length&&0===ie&&(t.searching=!1,X()),t.inputChanged&&(e=t.inputChanged(e)),e},t.fieldRequiredClass&&""!==t.fieldRequiredClass&&(se=t.fieldRequiredClass),t.minlength&&""!==t.minlength&&(ie=parseInt(t.minlength,10)),t.pause||(t.pause=v),t.clearSelected||(t.clearSelected=!1),t.overrideSuggestions||(t.overrideSuggestions=!1),t.fieldRequired&&s&&U(t.initialValue?!0:!1),t.inputType=o.type?o.type:"text",t.textSearching=o.textSearching?o.textSearching:x,t.textNoResults=o.textNoResults?o.textNoResults:C,ne="false"===t.textSearching?!1:!0,re="false"===t.textNoResults?!1:!0,t.maxlength=o.maxlength?o.maxlength:m,le.on("keydown",B),le.on("keyup",j),ee=D("remoteUrlResponseFormatter"),l(function(){var e=getComputedStyle(ue);de=e.maxHeight&&"auto"===e.overflowY})}var a=40,c=39,u=38,d=37,p=27,g=13,h=9,f=3,m=524288,v=500,S=200,w="autocomplete-required",x="Searching...",C="No results found",I="/angucomplete-alt/index.html";return i.put(I,'<div class="angucomplete-holder" ng-class="{\'angucomplete-dropdown-visible\': showDropdown}">  <input id="{{id}}_value" name="{{inputName}}" ng-class="{\'angucomplete-input-not-empty\': notEmpty}" ng-model="searchStr" ng-disabled="disableInput" type="{{inputType}}" placeholder="{{placeholder}}" maxlength="{{maxlength}}" ng-focus="onFocusHandler()" class="{{inputClass}}" ng-focus="resetHideResults()" ng-blur="hideResults($event)" autocapitalize="off" autocorrect="off" autocomplete="off" ng-change="inputChangeHandler(searchStr)"/>  <div id="{{id}}_dropdown" class="angucomplete-dropdown" ng-show="showDropdown">    <div class="angucomplete-searching" ng-show="searching" ng-bind="textSearching"></div>    <div class="angucomplete-searching" ng-show="!searching && (!results || results.length == 0)" ng-bind="textNoResults"></div>    <div class="angucomplete-row" ng-repeat="result in results" ng-click="selectResult(result)" ng-mouseenter="hoverRow($index)" ng-class="{\'angucomplete-selected-row\': $index == currentIndex}">      <div ng-if="imageField" class="angucomplete-image-holder">        <img ng-if="result.image && result.image != \'\'" ng-src="{{result.image}}" class="angucomplete-image"/>        <div ng-if="!result.image && result.image != \'\'" class="angucomplete-image-default"></div>      </div>      <div class="angucomplete-title" ng-if="matchClass" ng-bind-html="result.title"></div>      <div class="angucomplete-title" ng-if="!matchClass">{{ result.title }}</div>      <div ng-if="matchClass && result.description && result.description != \'\'" class="angucomplete-description" ng-bind-html="result.description"></div>      <div ng-if="!matchClass && result.description && result.description != \'\'" class="angucomplete-description">{{result.description}}</div>    </div>  </div></div>'),{restrict:"EA",require:"^?form",scope:{selectedObject:"=",disableInput:"=",initialValue:"=",localData:"=",remoteUrlRequestFormatter:"=",remoteUrlRequestWithCredentials:"@",remoteUrlResponseFormatter:"=",remoteUrlErrorCallback:"=",remoteApiHandler:"=",id:"@",type:"@",placeholder:"@",remoteUrl:"@",remoteUrlDataField:"@",titleField:"@",descriptionField:"@",imageField:"@",inputClass:"@",pause:"@",searchFields:"@",minlength:"@",matchClass:"@",clearSelected:"@",overrideSuggestions:"@",fieldRequired:"=",fieldRequiredClass:"@",inputChanged:"=",autoMatch:"@",focusOut:"&",focusIn:"&",inputName:"@",focusFirst:"@",parseInput:"&"},templateUrl:function(e,t){return t.templateUrl||I},compile:function(e){var t=o.startSymbol(),n=o.endSymbol();if("{{"!==t||"}}"!==n){var r=e.html().replace(/\{\{/g,t).replace(/\}\}/g,n);e.html(r)}return s}}}])});